                    ...
                    <form method="POST" action="{{ route('routers.update', $router) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="host" class="block mt-1 w-full" type="text" name="host" :value="old('host', $router->host)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="port" class="block mt-1 w-full" type="number" name="port" :value="old('port', $router->port)" required />
                            ...
                            <div class="md:col-span-2">
                                <label for="is_active" class="inline-flex items-center">
                                    <input id="is_active" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600" name="is_active" value="1" {{ old('is_active', $router->is_active) ? 'checked' : '' }}>
