        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="api">
                <form method="POST" action="{{ route('whatsapp.update') }}">
                    ...
                    <div class="mb-3">
                        <label>API URL</label>
                        <input type="text" class="form-control" name="whatsapp_api_url" value="{{ isset($waApiUrl) ? $waApiUrl->value : \App\Models\Setting::getValue('whatsapp_api_url', env('WHATSAPP_API_URL')) }}">
                    </div>
                    <div class="mb-3">
                        <label>API Key</label>
                ...
                <form method="POST" action="{{ route('whatsapp.update') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" rows="12" name="whatsapp_atk_receipt_template" id="atkTpl">{{ isset($atkReceiptTemplate) ? $atkReceiptTemplate->value : \App\Models\Setting::getValue('whatsapp_atk_receipt_template', '') }}</textarea>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" rows="12" name="whatsapp_wash_receipt_template" id="washTpl">{{ isset($washReceiptTemplate) ? $washReceiptTemplate->value : \App\Models\Setting::getValue('whatsapp_wash_receipt_template', '') }}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label>Live Preview</label>
            ...
            <div class="tab-pane fade" id="isp">
                <form method="POST" action="{{ route('whatsapp.update') }}">
                    ...
                    <textarea class="form-control mb-3" rows="6" name="whatsapp_isp_bill_template">{{ isset($ispBillTemplate) ? $ispBillTemplate->value : \App\Models\Setting::getValue('whatsapp_isp_bill_template', '') }}</textarea>
                    <label>Reminder Template</label>
                    <textarea class="form-control mb-3" rows="6" name="whatsapp_isp_reminder_template">{{ isset($ispReminderTemplate) ? $ispReminderTemplate->value : \App\Models\Setting::getValue('whatsapp_isp_reminder_template', '') }}</textarea>
                    <button type="submit" class="btn btn-primary">
                        Save ISP Templates
                    </button>
                </form>
