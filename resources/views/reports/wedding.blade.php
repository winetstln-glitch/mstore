...
@section('title', __('Wedding Report'))

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Wedding Report</h4>
        <div class="d-flex gap-2">
            <a class="btn btn-outline-danger" href="{{ route('reports.wedding.pdf', request()->query()) }}">PDF</a>
            <a class="btn btn-outline-success" href="{{ route('reports.wedding.excel', request()->query()) }}">Excel</a>
        </div>
    </div>
