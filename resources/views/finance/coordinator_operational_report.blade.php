    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <small class="text-muted">{{ __('Total uang masuk member') }}</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">{{ __('Total Beban Pengurus') }}</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">-{{ number_format($totalExpenses + $commission, 0, ',', '.') }}</div>
                    <small class="text-muted">{{ __('Operasional + Komisi 15%') }}</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">{{ __('Sisa Wajib Setor') }}</div>
                    <div class="h4 mb-0 font-weight-bold text-gray-800">{{ number_format($netBalance, 0, ',', '.') }}</div>
                    <small class="text-muted">{{ __('Pendapatan - Beban') }}</small>
                </div>
            </div>
        </div>
