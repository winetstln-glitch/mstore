            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('olt.update', $olt) }}">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            <label for="snmp_port" class="form-label">{{ __('SNMP Port') }}</label>
                        ...
                        <div class="col-md-6">
                            <label for="snmp_community" class="form-label">{{ __('SNMP Community') }}</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="model" id="model" class="form-select @error('model') is-invalid @enderror">
                                ...
                                <optgroup label="HIOSO / C-Data">
                                    <option value="HA7304" {{ old('model', $olt->model) == 'HA7304' ? 'selected' : '' }}>HA7304</option>
                                    <option value="HA7308" {{ old('model', $olt->model) == 'HA7308' ? 'selected' : '' }}>HA7308</option>
                                    <option value="HA7004" {{ old('model', $olt->model) == 'HA7004' ? 'selected' : '' }}>HA7004</option>
                                </optgroup>
                                <optgroup label="ZTE">
                                    <option value="C320" {{ old('model', $olt->model) == 'C320' ? 'selected' : '' }}>C320</option>
                                    <option value="C300" {{ old('model', $olt->model) == 'C300' ? 'selected' : '' }}>C300</option>
                                    <option value="C600" {{ old('model', $olt->model) == 'C600' ? 'selected' : '' }}>C600</option>
                                    <option value="C610" {{ old('model', $olt->model) == 'C610' ? 'selected' : '' }}>C610</option>
                                </optgroup>
                                <optgroup label="Huawei">
                                    <option value="MA5608T" {{ old('model', $olt->model) == 'MA5608T' ? 'selected' : '' }}>MA5608T</option>
                                    <option value="MA5680T" {{ old('model', $olt->model) == 'MA5680T' ? 'selected' : '' }}>MA5680T</option>
                                    <option value="MA5683T" {{ old('model', $olt->model) == 'MA5683T' ? 'selected' : '' }}>MA5683T</option>
                                    <option value="MA5800-X2" {{ old('model', $olt->model) == 'MA5800-X2' ? 'selected' : '' }}>MA5800-X2</option>
                                    <option value="MA5800-X7" {{ old('model', $olt->model) == 'MA5800-X7' ? 'selected' : '' }}>MA5800-X7</option>
                                </optgroup>
                                <optgroup label="VSOL">
                                    <option value="V1600D4" {{ old('model', $olt->model) == 'V1600D4' ? 'selected' : '' }}>V1600D4</option>
                                    <option value="V1600D8" {{ old('model', $olt->model) == 'V1600D8' ? 'selected' : '' }}>V1600D8</option>
                                    <option value="V1600G1" {{ old('model', $olt->model) == 'V1600G1' ? 'selected' : '' }}>V1600G1</option>
                                    <option value="V1600G2" {{ old('model', $olt->model) == 'V1600G2' ? 'selected' : '' }}>V1600G2</option>
                                </optgroup>
                                <optgroup label="HSGQ">
                                    <option value="G008" {{ old('model', $olt->model) == 'G008' ? 'selected' : '' }}>G008</option>
                                    <option value="G016" {{ old('model', $olt->model) == 'G016' ? 'selected' : '' }}>G016</option>
                                    <option value="G02ID" {{ old('model', $olt->model) == 'G02ID' ? 'selected' : '' }}>G02ID</option>
                                </optgroup>
                            </select>
                            @error('model')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="web_user" id="web_user" value="{{ old('web_user', $olt->web_user ?? 'admin') }}" class="form-control @error('web_user') is-invalid @enderror">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="password" name="web_password" id="web_password" value="{{ old('web_password', $olt->web_password ?? 'admin') }}" class="form-control @error('web_password') is-invalid @enderror" placeholder="{{ __('Leave blank to keep current password.') }}">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="latitude" name="latitude" value="{{ old('latitude', $olt->latitude) }}" class="form-control @error('latitude') is-invalid @enderror" placeholder="-6.200000">
                            @error('latitude')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="longitude" name="longitude" value="{{ old('longitude', $olt->longitude) }}" class="form-control @error('longitude') is-invalid @enderror" placeholder="106.816666">
                            @error('longitude')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
