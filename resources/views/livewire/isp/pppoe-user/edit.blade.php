        ...
        <div class="col-12 col-lg-10 px-3 px-lg-0">
            <div class="card shadow-sm border-0 border-top border-4 border-primary">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-body-emphasis fs-6 fs-md-5">Edit Pelanggan PPPoE</h5>
                    <a href="{{ route('pppoe-users.index') }}" class="btn btn-outline-secondary btn-sm">
                    ...
                    <form wire:submit="save">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            @if($createPortalUser)
                                ...
                                <div class="col-md-8">
                                    <label for="portalPassword" class="form-label small text-muted fw-bold">Password Portal (opsional, untuk mengubah)</label>
                                    <input type="password" wire:model="portalPassword" id="portalPassword" class="form-control @error('portalPassword') is-invalid @enderror" placeholder="minimal 8 karakter">
                        ...
                        <div class="d-flex flex-column-reverse flex-md-row justify-content-end gap-2 border-top pt-4">
                            <a href="{{ route('pppoe-users.index') }}" class="btn btn-outline-secondary w-100 w-md-auto">Batal</a>
                            <button type="submit" class="btn btn-primary w-100 w-md-auto px-4">
                                <span wire:loading.remove>Perbarui Pelanggan</span>
