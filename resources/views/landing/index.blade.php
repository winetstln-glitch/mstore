                ...
                <div class="col-md-6 col-lg-4" data-aos="flip-left" data-aos-delay="{{ 100 * $loop->iteration }}">
                    <div class="pricing-card h-100">
                        ...
                        <div class="pricing-body">
                            ...
                            <a href="https://wa.me/?text=Halo%20saya%20tertarik%20berlangganan%20paket%20{{ urlencode($package->name) }}" target="_blank" class="btn btn-primary btn-select-plan">
                                Pilih Paket
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="{{ 100 * $loop->iteration }}">
                    <div class="product-card h-100">
                        ...
                        <div class="product-body">
                            ...
                            <a href="https://wa.me/?text=Halo%20saya%20mau%20pesan%20ATK:%20{{ urlencode($product->name) }}" target="_blank" class="btn btn-outline-primary rounded-pill w-100 mt-auto">
                ...
                <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="{{ 100 * $loop->iteration }}">
                    <div class="product-card h-100 border-0 shadow-sm">
                        ...
                        <div class="product-body text-center">
                            ...
                            <a href="https://wa.me/?text=Halo%20saya%20mau%20booking%20cuci%20{{ $service->vehicle_type }}:%20{{ urlencode($service->name) }}" target="_blank" class="btn btn-success rounded-pill w-100">
