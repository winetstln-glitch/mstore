...
<div class="container-fluid">
    ...
    @include('atk._help-box', [
        'title' => 'Petunjuk Tambah Produk',
        'content' => '<p><strong>Isi form berikut untuk menambah produk baru!</strong></p><ul class="mb-0"><li><strong>Kode Produk:</strong> Opsional, jika dikosongkan sistem akan membuat kode otomatis.</li><li><strong>Nama Produk:</strong> Wajib diisi, nama produk yang jelas.</li><li><strong>Kategori:</strong> Pilih kategori untuk mengelompokkan produk.</li><li><strong>Harga Jual:</strong> Wajib diisi, harga jual produk kepada pelanggan.</li><li><strong>Stok Awal:</strong> Jumlah stok produk saat ini.</li><li><strong>Gambar:</strong> Opsional, upload gambar produk untuk memudahkan identifikasi di POS.</li></ul>'
    ])
            ...
            <form action="{{ route('atk.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="unit" class="form-control @error('unit') is-invalid @enderror" value="{{ old('unit', 'pcs') }}">
