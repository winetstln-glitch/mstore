...
<div class="container-fluid">
    ...
    @include('atk._help-box', [
        'title' => 'Petunjuk Riwayat Transaksi',
        'content' => '<p><strong>Halaman ini menampilkan semua riwayat transaksi POS!</strong></p><ul class="mb-0"><li><strong>Filter:</strong> Gunakan form filter untuk mencari transaksi berdasarkan tanggal atau kategori.</li><li><strong>Export:</strong> Klik "Export PDF" atau "Export Excel" untuk mengunduh laporan transaksi.</li><li><strong>Detail Transaksi:</strong> Klik pada transaksi untuk melihat detail lengkap dan struk.</li><li><strong>Transaksi Baru:</strong> Klik "New Transaction" untuk kembali ke halaman POS.</li></ul>'
    ])
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <form action="{{ route('atk.transactions.index') }}" method="GET" class="row g-3 align-items-center">
                ...
                <div class="col-12 col-md-auto">
                    <input type="text" id="search" name="search" class="form-control" placeholder="{{ __('Search transactions...') }}" value="{{ request('search') }}">
                </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $transaction->product_names['display'] }}
                                <small class="text-muted d-block">{{ $transaction->product_names['total'] }} item(s)</small>
                            </td>
