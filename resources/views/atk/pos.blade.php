...
<div class="atk-pos-page">
    <div class="atk-pos-shell">
        <header class="atk-pos-header d-flex justify-content-between align-items-center">
            <span id="current-time" class="atk-current-time"></span>
            <div class="d-flex align-items-center gap-3">
                <div class="text-end">
                    <small class="text-muted">Kas Utama</small>
                    <div id="main-cash-balance" class="fw-bold fs-5 text-success">
                        <i class="fa-solid fa-wallet me-1"></i>
                        Rp {{ number_format($cash->balance ?? 0, 0, ',', '.') }}
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="card mb-4 border-info">
            <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                <h6 class="mb-0"><i class="fa-solid fa-circle-info me-2"></i>Petunjuk Penggunaan POS</h6>
                <button class="btn btn-sm btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#posHelpBoxContent" aria-expanded="false" aria-controls="posHelpBoxContent">
                    <i class="fa-solid fa-chevron-down"></i>
                </button>
            </div>
            <div class="collapse" id="posHelpBoxContent">
                <div class="card-body">
                    <p><strong>Selamat datang di POS ATK!</strong> Berikut langkah-langkah transaksi:</p>
                    <ol class="mb-0">
                        <li><strong>Pilih Tab:</strong> Klik tab di atas untuk memilih jenis transaksi (Produk, Jasa, Bank, dll).</li>
                        <li><strong>Tambah Item:</strong>
                            <ul>
                                <li>Klik kartu produk untuk menambah ke keranjang.</li>
                                <li>Atau gunakan kolom pencarian untuk mencari produk cepat.</li>
                                <li>Atau klik tombol barcode untuk scan barcode produk!</li>
                            </ul>
                        </li>
                        <li><strong>Checkout:</strong>
                            <ul>
                                <li>Pilih metode pembayaran di bagian kanan.</li>
                                <li>Jika tunai, masukkan jumlah uang diterima (kembalian otomatis dihitung!)</li>
                                <li>Opsional: Isi nomor WA dan centang untuk kirim struk via WhatsApp.</li>
                            </ul>
                        </li>
                        <li><strong>Selesai:</strong> Klik "Proses Pembayaran"! Struk akan otomatis ditampilkan.</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="atk-card">
                    <div class="atk-card-header">
                        ...
                        <div class="atk-filter-group">
                            ...
                            <button class="filter-btn" data-tab="manual" type="button">Manual</button>
                    ...
                    <div class="atk-card-body">
                        ...
                        <div id="manualPanel" class="row g-3 d-none">
                            <div class="col-12">
                                <div class="p-3">
                                    <div class="row g-2 mb-3">
                                        <div class="col-12">
                                            <label class="atk-field-label">Nama Item</label>
                                            <input type="text" id="manualItemName" class="form-control atk-input" placeholder="Contoh: Pulpen / Cetak / Barang lain">
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <label class="atk-field-label">Harga</label>
                                            <div class="input-group">
                                                <span class="input-group-text atk-input-group-text">Rp</span>
                                                <input type="number" id="manualItemPrice" class="form-control atk-input" placeholder="0">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <label class="atk-field-label">Qty</label>
                                            <input type="number" id="manualItemQty" class="form-control atk-input" value="1" min="1">
                                        </div>
                                    </div>
                                    <button class="btn atk-primary-btn w-100" data-action="add-manual">
                                ...
                                <div class="p-3">
                                    <div class="row g-2 mb-3">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" id="customerPaymentCustomerName" class="form-control atk-input mt-2" placeholder="Atau ketik nama pelanggan (manual)">
                                        </div>
                                        <div class="col-12 col-md-6">
                                ...
                                <div class="p-3">
                                    <div class="row g-2 mb-3">
                                        <div class="col-12">
                                            ...
                                            <select id="bankFloatAccountId" class="form-select atk-input">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <label class="atk-field-label">Biaya Admin</label>
                                            <div class="input-group">
                                                <span class="input-group-text atk-input-group-text">Rp</span>
                            ...
                            <div class="col-12">
                                <div class="p-3">
                                    <div class="row g-2 mb-3">
                                        ...
                                        <div class="col-12">
                                            <label class="atk-field-label">Cara Pembayaran Biaya Admin</label>
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="cashOutFeeType" id="cashOutFeeTypeOutside" value="outside" checked>
                                                        <label class="form-check-label" for="cashOutFeeTypeOutside">
                                                            <strong>Di Luar</strong> (Bayar tunai terpisah)
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="cashOutFeeType" id="cashOutFeeTypeInside" value="inside">
                                                        <label class="form-check-label" for="cashOutFeeTypeInside">
                                                            <strong>Di Dalam</strong> (Potong dari nominal)
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="p-3">
                                    <div class="row g-2 mb-3">
                                        <div class="col-12">
                                            <label class="atk-field-label">Akun Float</label>
                                            <select id="topUpFloatAccountId" class="form-select atk-input">
                                                <option value="">Pilih Akun Float</option>
                                                @foreach(($floatAccounts ?? []) as $account)
                                                    <option value="{{ $account->id }}">{{ $account->name }} (Saldo: Rp {{ number_format($account->current_balance, 0, ',', '.') }})</option>
                                                @endforeach
                            ...
                            <div class="col-12">
                                <div class="p-3">
                                    <div class="row g-2 mb-3">
                                        <div class="col-12">
                                            <label class="atk-field-label">Akun Float</label>
                                            <select id="ppobFloatAccountId" class="form-select atk-input">
                                                <option value="">Pilih Akun Float</option>
                                                @foreach(($floatAccounts ?? []) as $account)
                                                    <option value="{{ $account->id }}">{{ $account->name }} (Saldo: Rp {{ number_format($account->current_balance, 0, ',', '.') }})</option>
                                                @endforeach
...
<!-- Modal Notifikasi -->
<div class="modal fade" id="atkNotificationModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" id="atkNotificationHeader">
                <h5 class="modal-title" id="atkNotificationTitle">Notifikasi</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
            </div>
            <div class="modal-body" id="atkNotificationBody">
                <!-- Pesan akan dimasukkan disini -->
            </div>
            <div class="modal-footer">
                <button type="button" class="btn atk-primary-btn" data-bs-dismiss="modal">OK</button>
            </div>
        </div>
    </div>
</div>
...
// Fungsi menampilkan notifikasi modal
function showNotification(title, message, type = 'info') {
    const modal = new bootstrap.Modal(document.getElementById('atkNotificationModal'));
    const header = document.getElementById('atkNotificationHeader');
    const titleEl = document.getElementById('atkNotificationTitle');
    const body = document.getElementById('atkNotificationBody');
    
    // Set warna header berdasarkan type
    ...
    // Pesan spesifik dengan panduan
    let bodyContent = `<p class="mb-0">${message}</p>`;
    if (message.toLowerCase().includes('saldo kas utama')) {
        bodyContent += `
            <div class="alert alert-warning mt-3 mb-0">
                <h6 class="alert-heading"><i class="fas fa-lightbulb me-2"></i> Panduan</h6>
                <p class="mb-1">Untuk menambah saldo Kas Utama, anda bisa:</p>
                <ul class="mb-0">
                    <li>Menggunakan fitur <strong>Dana Talangan</strong> di menu ATK → Dana Talangan (cara paling mudah untuk mencatat pinjaman dari bos)</li>
                    <li>Atau membuat <strong>Mutasi Kas Masuk</strong> di menu ATK → Mutasi Kas Utama → Tambah Mutasi</li>
                </ul>
            </div>
        `;
    }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (cartList) {
        cartList.addEventListener('click', function(e) {
            ...
            const updateBtn = e.target.closest('[data-action="update-quantity"]');
            if (updateBtn) {
                e.preventDefault();
                e.stopPropagation();
                const itemId = parseInt(updateBtn.dataset.itemId);
    ...
    document.addEventListener('keydown', function(e) {
        ...
        // Submit checkout with Enter (when not in input)
    ...
    document.getElementById('productSearch').addEventListener('input', function(e) {
        ...
        } else if (!document.getElementById('manualPanel').classList.contains('d-none')) {
            return;
...
function switchTab(tab) {
    ...
    const mPanel = document.getElementById('manualPanel');
    ...
    if (tab === 'products') {
        ...
        mPanel.classList.remove('d-none');
        filterBtns.forEach(btn => { if (btn.dataset.tab === 'manual') btn.classList.add('active'); });
    } else if (tab === 'bank') {
...
function addBankToCart() {
    const floatAccountId = document.getElementById('bankFloatAccountId').value;
    ...
    cart.push({ id, name, price: fee, quantity: 1, maxStock: 1, bank: true, nominal_transaksi: nominal, fee, float_account_id: floatAccountId });
    renderCart();
}
...
function addCustomerPaymentToCart() {
    ...
    const manualCustomerName = String(document.getElementById('customerPaymentCustomerName')?.value || '').trim();
    const nominal = parseFloat(document.getElementById('customerPaymentNominal').value) || 0;
    if (!customerId && !manualCustomerName) {
        alert('Pilih pelanggan atau isi nama pelanggan manual terlebih dahulu.');
        return;
    }
    if (nominal <= 0) {
    ...
    const customerName = customerId
        ? (customerSelect.selectedOptions[0]?.dataset?.name || customerSelect.selectedOptions[0]?.text || 'Pelanggan')
        : manualCustomerName;
    const id = customerId ? (900000000 + customerId) : (900000000 + Date.now());
...
function addManualItemToCart() {
    const name = String(document.getElementById('manualItemName')?.value || '').trim();
    ...
    if (!name) {
        alert('Nama item manual wajib diisi.');
        return;
    }
    if (price <= 0) {
        alert('Harga item manual wajib diisi.');
        return;
    }
    if (qty <= 0) {
        alert('Qty item manual wajib diisi.');
        return;
    }
    const id = 910000000 + Date.now();
    cart.push({
        id,
        name,
        product_name: name,
...
function addCashOutToCart() {
    ...
    const feeType = document.querySelector('input[name="cashOutFeeType"]:checked')?.value || 'outside';
...
function addTopUpToCart() {
    const floatAccountId = document.getElementById('topUpFloatAccountId').value;
...
function addPPOBToCart() {
    const floatAccountId = document.getElementById('ppobFloatAccountId').value;
...
function calculateTotal() {
    let total = 0;
    cart.forEach(item => {
        if (item.cashOut && item.fee_type === 'inside') {
            // Biaya admin di dalam: total hanya nominal (karena biaya dipotong dari nominal)
            total += item.nominal_transaksi || 0;
        } else if (item.bank || item.cashOut || item.topUp || item.ppob) {
            total += ((item.nominal_transaksi || 0) + (item.fee || 0));
        } else {
...
function renderCart() {
    ...
    if (cart.length === 0) {
        ...
        cart.forEach(item => {
            ...
            let subtotal;
            if (item.cashOut && item.fee_type === 'inside') {
                subtotal = item.nominal_transaksi || 0;
            } else if (item.bank || item.cashOut || item.topUp || item.ppob) {
                subtotal = ((item.nominal_transaksi || 0) + (item.fee || 0));
            } else {
            ...
            if (item.bank || item.cashOut || item.topUp || item.ppob) {
                if (item.nominal_transaksi) {
                    ...
                    if (item.fee) {
                        const feeTypeText = (item.cashOut && item.fee_type === 'inside') ? ' (Di Dalam)' : ' (Di Luar)';
                        metaText += ` | Biaya Admin: Rp ${new Intl.NumberFormat('id-ID').format(item.fee)}${feeTypeText}`;
                    }
                }
            } else {
            ...
            `;
            console.log('Created cart item:', item, 'button data-action:', 'remove-item', 'data-item-id:', item.id);
...
function calculateChange() {
    ...
    // Calculate total cash out fee only for items where fee_type is 'outside'
    const hasCashOut = cart.some(item => item.cashOut === true);
    const totalCashOutFee = hasCashOut 
        ? cart.filter(item => item.cashOut === true && item.fee_type === 'outside')
               .reduce((sum, item) => sum + (item.fee || 0), 0) 
        : 0;
    
    const allCashOutInside = hasCashOut && cart.every(item => !item.cashOut || item.fee_type === 'inside');
    
    const change = method === 'cash' 
        ? (hasCashOut && !allCashOutInside 
            ? (cash - totalCashOutFee) 
            : (cash - total)) 
        : 0;
    ...
    // Update label
    const cashInputLabel = document.querySelector('label[for="cashAmount"]');
    if (cashInputLabel) {
        if (hasCashOut && !allCashOutInside) {
            cashInputLabel.textContent = 'Biaya Admin (Tunai)';
        } else {
            cashInputLabel.textContent = 'Uang Diterima';
        }
    }
    ...
    if (changeLabel) {
        if (hasCashOut && !allCashOutInside) {
            changeLabel.textContent = 'Kembalian Admin';
        } else {
...
function processTransaction() {
        ...
        // Cek apakah ada cash_out dan filter fee only for outside
        const hasCashOut = cart.some(item => item.cashOut === true);
        const totalCashOutFee = hasCashOut 
            ? cart.filter(item => item.cashOut === true && item.fee_type === 'outside')
                   .reduce((sum, item) => sum + (item.fee || 0), 0) 
        ...
        if (paymentMethod === 'cash') {
            if (hasCashOut && !allCashOutInside) {
                // Untuk cash_out dengan fee outside, uang diterima harus cukup untuk biaya admin saja
                if (cashAmount < totalCashOutFee) {
                    alert('Uang diterima untuk biaya admin tidak cukup!');
                    return;
                }
            } else {
                // Transaksi biasa atau cash_out dengan fee inside, uang diterima harus cukup untuk total
                if (cashAmount < total) {
    ...
    const data = {
            items: cart.map(item => {
                const mappedItem = {
                    id: item.customerPayment || item.cashOut || item.topUp || item.ppob || item.manual ? null : item.id,
                    type: item.bank ? 'bank' : (item.service ? 'service' : (item.manual ? 'manual' : (item.customerPayment ? 'customer_payment' : (item.cashOut ? 'cash_out' : (item.topUp ? 'top_up' : (item.ppob ? 'ppob' : 'product')))))),
                    quantity: item.quantity,
                    product_name: item.manual ? item.product_name : undefined,
                    price: item.manual ? item.price : undefined,
                    ...
                    fee_type: item.cashOut ? item.fee_type : undefined,
                    customer_name: item.customerPayment ? item.customerName : undefined,
                    float_account_id: (item.bank || item.cashOut || item.topUp || item.ppob) ? item.float_account_id : undefined
                };
                return mappedItem;
            }),
    ...
    .then(async response => {
        if (!response.ok) {
            ...
            try {
                ...
                // If not JSON, check if it starts with "Server error: XXX - " and extract message
                const match = errorText.match(/Server error: \d+ - (.+)/);
                if (match) {
                    try {
                        const innerJson = JSON.parse(match[1]);
                        if (innerJson.message) {
                            errorMessage = innerJson.message;
                        } else if (innerJson.error) {
                            errorMessage = innerJson.error;
                        } else {
    ...
    .then(async result => {
        if (result.success) {
            ...
            // 2. Update Kas Utama display
            if (typeof result.cash_balance !== 'undefined') {
                const formattedBalance = 'Rp ' + result.cash_balance.toLocaleString('id-ID');
                document.getElementById('main-cash-balance').innerHTML = 
                    '<i class="fa-solid fa-wallet me-1"></i>' + formattedBalance;
            }
            
            // 3. Try to send WhatsApp receipt if needed
            ...
            // 4. Re-render empty cart
            renderCart();

            // 5. Handle receipt display
            ...
            // 6. Reset checkout button to enabled
            btn.disabled = false;
            btn.innerHTML = 'Proses Pembayaran';
            
            // 7. Show success message
            showNotification('Berhasil', 'Transaksi berhasil!', 'success');
        } else {
    ...
    .catch(error => {
        showNotification('Kesalahan', error.message, 'error');
        btn.disabled = false;
        btn.innerHTML = 'Proses Pembayaran';
    });
}
