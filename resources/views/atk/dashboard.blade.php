...
<div class="container-fluid">
    ...
    @include('atk._help-box', [
        'title' => 'Petunjuk Dasbor',
        'content' => '<p><strong>Selamat datang di Dasbor ATK!</strong> Halaman ini menampilkan ringkasan operasional toko kamu hari ini.</p><ul class="mb-0"><li><strong>Statistik Utama:</strong> Klik pada kotak statistik untuk melihat detail lebih lanjut.</li><li><strong>Ringkasan Keuangan:</strong> Lihat saldo kas utama, float accounts, dan dana talangan owner.</li><li><strong>Produk Terlaris:</strong> Lihat 5 produk yang paling banyak terjual.</li><li><strong>Aksi Cepat:</strong> Gunakan tombol untuk langsung menuju fitur yang sering dipakai.</li></ul>'
    ])
