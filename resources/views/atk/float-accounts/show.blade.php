...
<div class="container-fluid">
    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-2 mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('atk.float-accounts.create-transaction', $account) }}" class="btn btn-success">
    ...
    @include('atk._help-box', [
        'title' => 'Petunjuk Detail Akun',
        'content' => '<p><strong>Halaman ini menampilkan detail dan riwayat transaksi akun float!</strong></p><ul class="mb-0"><li><strong>Informasi Akun:</strong> Lihat kode, nama, tipe, saldo, dan status akun.</li><li><strong>Tambah Transaksi:</strong> Klik "Tambah Transaksi" untuk mencatat deposit, tarik tunai, dll.</li><li><strong>Riwayat Transaksi:</strong> Lihat semua perubahan saldo akun beserta saldo awal dan akhir.</li></ul>'
    ])
