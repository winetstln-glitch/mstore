...
<div class="row">
    ...
    <div class="col-12 col-lg-8">
        <div class="card shadow-sm border-0 mb-3 mb-md-4">
            <div class="card-body p-3 p-md-4">
                ...
                @if($ticket->address)
                    <div class="mb-4">
                        <h6 class="fw-bold border-bottom pb-2 mb-3">{{ __('Alamat') }}</h6>
                        <p class="text-body-secondary small mb-0" style="white-space: pre-line;">{{ $ticket->address }}</p>
                    </div>
                @endif
    ...
    <div class="col-12 col-lg-4">
        ...
        <div class="card shadow-sm border-0 mb-3 mb-md-4">
            ...
            <div class="card-body">
                @if($ticket->customer || $ticket->manual_customer_name)
                    <div class="d-flex align-items-center mb-3">
                        <div class="bg-primary bg-opacity-10 text-primary rounded-circle p-3 me-3">
                            <i class="fa-solid fa-user fa-lg"></i>
                        </div>
                        <div class="overflow-hidden">
                            <h6 class="mb-0 fw-bold text-truncate">{{ $ticket->customer_name }}</h6>
                            <small class="text-body-secondary">{{ $ticket->customer ? __('Pelanggan') : __('Pelanggan Manual') }}</small>
                        </div>
                    </div>
                    @if($ticket->customer)
                        <ul class="list-unstyled mb-0 small">
                            @if($ticket->address)
                                <li class="mb-2">
                                    <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($ticket->address) }}" target="_blank" class="text-decoration-none text-body-secondary">
                                        <i class="fa-solid fa-location-dot me-2"></i> <span class="text-break">{{ Str::limit($ticket->address, 40) }}</span>
                                    </a>
                                </li>
                            @endif
