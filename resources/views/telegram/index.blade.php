...
<div class="row">
    <div class="col-12">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card bg-light border-0 mb-3">
                                    <div class="card-body">
                                        <label for="telegram_router_group_id" class="form-label fw-bold">{{ __('Router Notification') }}</label>
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox" role="switch" id="telegram_router_notification_enabled" name="telegram_router_notification_enabled" value="1" {{ \App\Models\Setting::getValue('telegram_router_notification_enabled', '1') == '1' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="telegram_router_notification_enabled">{{ __('Aktifkan Notifikasi Router') }}</label>
                                        </div>
                                        <div class="input-group mb-2">
                                            <span class="input-group-text"><i class="fa-solid fa-users"></i></span>
                                            <input type="text" name="telegram_router_group_id" id="telegram_router_group_id" value="{{ \App\Models\Setting::getValue('telegram_router_group_id') }}" class="form-control" placeholder="-100xxxxxxxxx">
                                        </div>
                                        <div class="form-text small">{{ __('ID Grup Telegram untuk notifikasi status router (ONLINE/OFFLINE).') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <label class="form-label fw-semibold">{{ $ticket_created_telegram_template->label }}</label>
                <textarea class="form-control" rows="8" name="ticket_created_telegram_template">{{ $ticket_created_telegram_template->value }}</textarea>
                <div class="form-text">
                    Placeholder: <code>{ticket_number}</code>, <code>{ticket_type}</code>, <code>{customer_name}</code>, <code>{ticket_subject}</code>, <code>{ticket_priority}</code>, <code>{ticket_address}</code>, <code>{ticket_url}</code>
                </div>
            </div>
            <div class="col-md-6">
                <label class="form-label fw-semibold">{{ $ticket_assigned_telegram_template->label }}</label>
                <textarea class="form-control" rows="8" name="ticket_assigned_telegram_template">{{ $ticket_assigned_telegram_template->value }}</textarea>
                <div class="form-text">
                    Placeholder: <code>{technician_name}</code>, <code>{ticket_number}</code>, <code>{ticket_subject}</code>, <code>{customer_name}</code>, <code>{ticket_location}</code>, <code>{ticket_priority}</code>, <code>{ticket_description}</code>, <code>{ticket_url}</code>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <label class="form-label fw-semibold">{{ $ticket_status_updated_telegram_template->label }}</label>
                <textarea class="form-control" rows="8" name="ticket_status_updated_telegram_template">{{ $ticket_status_updated_telegram_template->value }}</textarea>
                <div class="form-text">
                    Placeholder: <code>{ticket_number}</code>, <code>{ticket_subject}</code>, <code>{new_status}</code>, <code>{updated_by}</code>, <code>{ticket_url}</code>
                </div>
            </div>
            <div class="col-md-6">
                <label class="form-label fw-semibold">{{ $ticket_solved_telegram_template->label }}</label>
                <textarea class="form-control" rows="8" name="ticket_solved_telegram_template">{{ $ticket_solved_telegram_template->value }}</textarea>
                <div class="form-text">
                    Placeholder: <code>{ticket_number}</code>, <code>{customer_name}</code>, <code>{ticket_subject}</code>, <code>{updated_by}</code>, <code>{ticket_note}</code>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <label class="form-label fw-semibold">{{ $ticket_assigned_group_telegram_template->label }}</label>
                <textarea class="form-control" rows="8" name="ticket_assigned_group_telegram_template">{{ $ticket_assigned_group_telegram_template->value }}</textarea>
                <div class="form-text">
                    Placeholder: <code>{ticket_number}</code>, <code>{ticket_subject}</code>, <code>{technician_name}</code>, <code>{technician_names}</code>, <code>{updated_by}</code>, <code>{ticket_url}</code>
                </div>
            </div>
        </div>
    </div>
