...
class ZTEOLTAdapter implements NetworkProviderInterface
{
    ...
    {
        $config = config('network.providers.zteolt', []);
    ...
    {
        Log::warning('ZTEOLTAdapter: executeOltCommand is a placeholder', ['command' => $command]);
        return false;
    }
}
