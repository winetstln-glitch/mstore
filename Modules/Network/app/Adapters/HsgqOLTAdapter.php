...
class HsgqOLTAdapter implements NetworkProviderInterface
{
    ...
    {
        $config = config('network.providers.hsgqolt', []);
    ...
    {
        Log::warning('HsgqOLTAdapter: executeOltCommand is a placeholder', ['command' => $command]);
        return false;
    }
}
