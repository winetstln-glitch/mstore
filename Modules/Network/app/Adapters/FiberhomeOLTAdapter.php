...
class FiberhomeOLTAdapter implements NetworkProviderInterface
{
    ...
    {
        $config = config('network.providers.fiberhomeolt', []);
    ...
    {
        Log::warning('FiberhomeOLTAdapter: executeOltCommand is a placeholder', ['command' => $command]);
        return false;
    }
}
