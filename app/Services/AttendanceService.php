...
class AttendanceService
{
    ...
    public function checkClockInRules(User $user): ?array
    {
        ...
        if (!$allowAfterCutoff && $this->isPastCutoffTime($clockInWindow['shift_cutoff'])) {
            $cutoffTime = $clockInWindow['shift_cutoff'];
            return ['error' => "Anda tidak bisa melakukan absen sudah melewati batas toleransi absen jam {$cutoffTime} WIB. Status kehadiran Anda akan dicatat sebagai Alpha."];
        }
