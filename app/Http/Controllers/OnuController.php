...
class OnuController extends Controller implements HasMiddleware
{
    ...
    public function update(Request $request, Onu $onu)
    {
        ...
        try {
            $olt = $onu->olt;
            $this->monitoringService->setOnuName($olt, $onu->onu_index ?? $onu->interface, $validated['name']);
        } catch (\Exception $e) {
    ...
    public function reboot(Request $request, Onu $onu)
    {
        try {
            $olt = $onu->olt;
            $this->monitoringService->rebootOnu($olt, $onu->interface);
    ...
    public function sync(OLT $olt, Request $request)
    {
        ...
        try {
            $onuDataList = $this->monitoringService->getOltOnus($olt);
