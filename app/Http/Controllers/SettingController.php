...
class SettingController extends Controller implements HasMiddleware
{
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            ...
            'wash_commission_car_small_medium' => 'nullable|integer|min:0',
            'wash_commission_car_large_xlarge' => 'nullable|integer|min:0',
            'wash_commission_motor_small_medium' => 'nullable|integer|min:0',
            'wash_commission_motor_large_xlarge' => 'nullable|integer|min:0',
            'wash_commission_exclude_free_wash' => 'nullable|in:0,1',
            'wash_commission_only_main_services' => 'nullable|in:0,1',
            'wash_commission_require_employee' => 'nullable|in:0,1',
