...
class WhatsAppController extends Controller implements HasMiddleware
{
    ...
    {
        $settings = $this->templateService->getAllSettings();
        $templateDefs = $this->templateService->getTemplateDefinitions();
        $maskedWaApiKey = $this->templateService->maskApiKey($settings['whatsapp_api_key']->value);
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'ticket_created_whatsapp_template' => 'nullable|string',
            'ticket_assigned_whatsapp_template' => 'nullable|string',
            'ticket_status_updated_whatsapp_template' => 'nullable|string',
            'ticket_solved_whatsapp_template' => 'nullable|string',
            'ticket_assigned_group_whatsapp_template' => 'nullable|string',
            // API settings
            'whatsapp_api_url' => 'nullable|string',
            'whatsapp_api_key' => 'nullable|string',
            'whatsapp_secret_key' => 'nullable|string',
            // Group settings - WhatsApp
        ...
        $templateLabels = [
            ...
            // New notification templates
            'ticket_created_whatsapp_template' => 'Template Notifikasi WhatsApp: Tiket Baru (Grup)',
            'ticket_assigned_whatsapp_template' => 'Template Notifikasi WhatsApp: Tiket Diberikan (Teknisi)',
            'ticket_status_updated_whatsapp_template' => 'Template Notifikasi WhatsApp: Status Tiket Diperbarui',
            'ticket_solved_whatsapp_template' => 'Template Notifikasi WhatsApp: Tiket Selesai (Grup)',
            'ticket_assigned_group_whatsapp_template' => 'Template Notifikasi WhatsApp: Teknisi Ditugaskan (Grup)',
        ];
        ...
        $apiKeyInput = $request->input('whatsapp_api_key');
        if (!empty($apiKeyInput)) {
            $key = trim((string) $apiKeyInput);
