...
class SidebarMenu
{
        ...
        return [
            [
                ...
                'items' => [
                    ...
                    self::link('dashboard-consolidated', 'Dashboard Konsolidasi', 'consolidation.index', permissions: ['consolidation.view']),
            ...
            [
                ...
                'items' => [
                    ...
                    self::group('services', 'Layanan Internet', [
                        self::link('hotspot-profiles', 'Paket Internet', 'hotspot.profiles.index', routePatterns: ['hotspot.profiles.*', 'packages.*'], permissions: ['hotspot.profile.view']),
                        self::link('pppoe-active', 'PPPoE Aktif', 'pppoe.index', routePatterns: ['pppoe.*'], permissions: ['pppoe.view']),
                        self::link('hotspot-active', 'Hotspot Aktif', 'hotspot.index', routePatterns: ['hotspot.index', 'hotspot.online', 'hotspot.profiles.*'], permissions: ['hotspot.view']),
                        self::link('voucher-hotspot', 'Voucher Hotspot', 'vouchers.index', permissions: ['voucher.view']),
                        self::link('hotspot-banners', 'Banner Hotspot', 'hotspot.banners.index', routePatterns: ['hotspot.banners.*'], permissions: ['hotspot.view']),
            ...
            [
                ...
                'items' => [
                    self::group('net-monitoring', 'Monitoring', [
                        ...
                        self::link('net-map', 'Monitor Peta Jaringan', 'map.index', permissions: ['map.view']),
            ...
            [
                ...
                'items' => [
                    self::link('companies', 'Manajemen Perusahaan', 'companies.index', permissions: ['company.view']),
            ...
            [
                ...
                'items' => [
                    self::group('hr', 'HR', [
                        ...
                        self::link('kasbon', 'Kasbon', 'technicians.kasbon.index', permissions: ['kasbon.view', 'kasbon.manage']),
                        self::link('payslip', 'Slip Gaji', 'attendance.payslip', permissions: ['attendance.view']),
                    ], permissions: ['employee.view', 'attendance.view', 'schedule.view', 'leave.view', 'leave.manage', 'kasbon.view']),
            ...
            [
                ...
                self::group('atk-transactions', 'Transaksi', [
                    self::link('atk-transactions-list', 'Riwayat Transaksi', 'atk.transactions.index', permissions: ['atk.report']),
                ], permissions: ['atk.view']),
                self::group('atk-finance', 'Keuangan', [
                    self::link('atk-float-accounts', 'Akun Float', 'atk.float-accounts.index', permissions: ['atk.view']),
                    self::link('atk-owner-funds', 'Dana Talangan', 'atk.owner-funds.index', permissions: ['atk.manage']),
                    self::link('atk-expenses', 'Pengeluaran ATK', 'atk.expenses.index', permissions: ['atk.report']),
                ...
                self::group('atk-reports', 'Laporan', [
                    ...
                    self::group('bu-wash', 'GT Wash', [
                        ...
                        self::link('wash-expenses', 'Pengeluaran', 'wash.expenses.index', permissions: ['wash.expense.view', 'wash.report', 'wash.manage']),
                        ...
                        self::link('wash-suppliers', 'Supplier', 'wash.suppliers.index', permissions: ['wash.supplier.view']),
                        self::link('wash-shifts', 'Shift', 'wash.shifts.index', permissions: ['wash.shift.view']),
                        self::link('wash-shift-sessions', 'Sesi Shift', 'wash.shift-sessions.index', permissions: ['wash.shift.view']),
                        self::link('wash-cash-registers', 'Kasir', 'wash.cash-registers.index', permissions: ['wash.cash.view']),
                        self::link('wash-cash-movements', 'Mutasi Kas', 'wash.cash-movements.index', permissions: ['wash.cash.view']),
                        self::link('wash-daily-closings', 'Penutupan Harian', 'wash.daily-closings.index', permissions: ['wash.closing.view']),
            ...
            [
                ...
                'roles' => ['customer'],
                'items' => [
                    self::link('portal-onu-wifi', 'Ganti Password WiFi', 'client.onu-wifi.show', roles: ['customer']),
                ],
            ],
        ];
    }
    ...
    private static function inferIcon(string $id, string $label, ?string $route = null, string $type = 'link'): string
    {
        ...
        $map = [
            ...
            'field-leader' => 'fa-solid fa-user-tie',
