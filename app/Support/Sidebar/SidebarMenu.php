            ...
            [
                ...
                'items' => [
                    self::group('hr', 'HR', [
                        ...
                        self::link('kasbon', 'Kasbon', 'technicians.kasbon.index', roles: [Role::ADMIN, Role::FINANCE, Role::HRD_MANAGER, Role::DIREKTUR]),
            ...
            [
                ...
                self::group('atk-reports', 'Laporan', [
                    ...
                    self::group('bu-wash', 'GT Wash', [
                        ...
                        self::link('wash-suppliers', 'Supplier', 'wash.suppliers.index', permissions: ['wash.supplier.view', 'wash.supplier.manage', 'wash.manage']),
                        self::link('wash-shifts', 'Shift', 'wash.shifts.index', permissions: ['wash.shift.view', 'wash.shift.manage', 'wash.manage']),
                        self::link('wash-shift-sessions', 'Sesi Shift', 'wash.shift-sessions.index', permissions: ['wash.shift.view', 'wash.shift.open', 'wash.shift.close', 'wash.manage']),
                        self::link('wash-cash-registers', 'Kasir', 'wash.cash-registers.index', permissions: ['wash.cash.view', 'wash.cash.manage', 'wash.manage']),
                        self::link('wash-cash-movements', 'Mutasi Kas', 'wash.cash-movements.index', permissions: ['wash.cash.view', 'wash.cash.manage', 'wash.manage']),
                        self::link('wash-daily-closings', 'Penutupan Harian', 'wash.daily-closings.index', permissions: ['wash.closing.view', 'wash.closing.create', 'wash.closing.approve', 'wash.manage']),
