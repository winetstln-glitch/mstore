            ...
            [
                ...
                self::group('atk-reports', 'Laporan', [
                    ...
                    self::group('bu-wash', 'GT Wash', [
                        ...
                        self::link('wash-suppliers', 'Supplier', 'wash.suppliers.index', permissions: ['wash.manage']),
                        self::link('wash-shifts', 'Shift', 'wash.shifts.index', permissions: ['wash.manage']),
                        self::link('wash-shift-sessions', 'Sesi Shift', 'wash.shift-sessions.index', permissions: ['wash.manage']),
                        self::link('wash-cash-registers', 'Kasir', 'wash.cash-registers.index', permissions: ['wash.manage']),
                        self::link('wash-cash-movements', 'Mutasi Kas', 'wash.cash-movements.index', permissions: ['wash.manage']),
                        self::link('wash-daily-closings', 'Penutupan Harian', 'wash.daily-closings.index', permissions: ['wash.manage']),
